...
logical :: USB
real(KIND=8) :: US_min, kappa_min, kappa_max
! Related variables
real(KIND=8) :: US_tol
integer :: maxNbis
...
! Problem matrices
real(KIND=8), dimension(:, :), allocatable :: A0_aij, ApkN_aij
real(KIND=8), dimension(:, :, :, :), allocatable :: Alookup
real(KIND=8), dimension(:, :), allocatable :: R_A
real(KIND=8), dimension(:), allocatable :: L0_A
