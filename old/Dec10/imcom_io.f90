...
if (n1pad.lt.(n1(1) * 2)) n1pad = n1(1) * 2
if (n2pad.lt.(n2(1) * 2)) n2pad = n2(1) * 2
...
write(*, '(A)') "IMCOM v0.1 [usage]: "
write(*, '(A)') " ./imcom <config_file> <U/S> <U/S_min> <U/S_tol> <kappa_min> <kappa_max> <maxNbis>"
write(*, '(A)') " "
...
write(*, '(A)') " "
write(*, '(A)') "    <kappa_min> [dbl] : Minimum kappa for interval bisection"
write(*, '(A)') " "
write(*, '(A)') "    <kappa_max> [dbl] : Maximum kappa for interval bisection"
write(*, '(A)') " "
write(*, '(A)') "    <maxNbis> [int] : Maximum number of interval bisections"
write(*, '(A)') " "
write(*, '(A)') "    <T_file> [string] : Input/output T matrix file"
write(*, '(A)') " "
