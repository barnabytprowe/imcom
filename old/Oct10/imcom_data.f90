...
character(LEN=256), dimension(:), allocatable :: psfxfile, psfyfile
...
real(KIND=8), dimension(:), allocatable :: kN, Ndiag
...
! Problem matrices
real(KIND=8), dimension(:, :), allocatable :: A_aij, ApkN_aij
...
real(KIND=8), dimension(:, :), allocatable :: B_ia, Bl_ia
...
! Temporary stuff
real(KIND=8), dimension(:), allocatable :: U_calc_a
real(KIND=8), dimension(:, :), allocatable :: U_calc
