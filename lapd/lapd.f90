...
!
!    DESCRIPTION
!    Please see the file LAPD_DOCUMENTATION.PDF for details on the
!    installation, configuration and running of the LAPD package.
...
call lapd_get_cmdline
call lapd_welcome

! Read the config files
call lapd_read_config(config, userxy)
